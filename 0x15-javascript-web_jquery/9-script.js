...
$(document).ready(function () { // long form of $(function())
  $.get(url, function (data) {
    $('#sf_wind_speed').text(data.query.results.channel.wind.speed); // pulls specificied output. check link above for clarification
  });
});
